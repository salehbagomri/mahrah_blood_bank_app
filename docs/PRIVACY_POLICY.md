...
- **آخر تاريخ تبرع**: لضمان مرور الفترة الآمنة بين التبرعات
...
- **سجلات التبرعات**: لتتبع تاريخ تبرعاتك
...
- **إرسال إشعارات الطوارئ**: إعلامك عند وجود حالة طارئة تحتاج فصيلة دمك
- **إدارة سجل التبرعات**: تتبع تبرعاتك السابقة
...
✅ **مع المحتاجين للدم فقط**: يمكن للمحتاجين رؤية:
   - اسمك
   - رقم هاتفك
   - فصيلة دمك
   - مديريتك

✅ **مع المسؤولين (Admins)**: للإشراف على النظام وإدارة البلاغات
...
- 📷 **الكاميرا**: لالتقاط صورة شخصية (اختياري)
- 🖼️ **المعرض**: لاختيار صورة من جهازك (اختياري)
- 🔔 **الإشعارات**: لإرسال تنبيهات حالات الطوارئ
...
When registering as a donor, we collect:
...
- **Last Donation Date**: To ensure safe interval between donations
...
- **Donation Records**: To track your donation history
...
- **Send Emergency Notifications**: Notify you when urgent cases need your blood type
- **Manage Donation Records**: Track your previous donations
...
#### 5.2 Limited Sharing
✅ **With blood recipients only**: Recipients can see:
   - Your name
   - Your phone number
   - Your blood type
   - Your district

✅ **With Admins**: For system supervision and report management
...
- 📷 **Camera**: To take a profile picture (optional)
- 🖼️ **Gallery**: To choose a picture from your device (optional)
- 🔔 **Notifications**: To send emergency alerts
