...
-- القراءة لجميع المتبرعين النشطين (للبحث والإبلاغ)
CREATE POLICY "public_select_available_donors"
ON donors
FOR SELECT
TO anon, authenticated
USING (
    -- يمكن رؤية جميع المتبرعين النشطين (حتى الموقوفين)
    -- لأن ميزة الإبلاغ تحتاج للتحقق من وجود الرقم
    is_active = true
);
...
1. المستخدمين العاديين (Public):
   - القراءة: جميع المتبرعين النشطين (متاح + موقوف)
     * ضروري لميزة الإبلاغ - للتحقق من وجود الرقم
